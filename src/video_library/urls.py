...
urlpatterns = [
    ...
    path('video/', views.VideoView.as_view({'get': 'list', 'post': 'create'})),
    path('video/<int:pk>/', views.VideoView.as_view({'put': 'update', 'delete': 'destroy'})),

    path('stream-video/<int:pk>/', views.StreamingFileView.as_view()),
    path('download-video/<int:pk>/', views.DownloadVideoView.as_view()),

    path('stream-author-video/<int:pk>/', views.StreamingFileAuthorView.as_view()),

    path('video-list/', views.VideoListView.as_view()),
    path('author-video-list/<int:pk>/', views.AuthorVideoListView.as_view()),
