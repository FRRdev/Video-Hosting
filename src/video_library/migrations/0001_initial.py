# Generated by Django 4.0 on 2021-12-27 07:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='video_library.album')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracks', models.ManyToManyField(related_name='track_play_lists', to='video_library.Track')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=1000)),
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('track', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='track_comments', to='video_library.track')),
